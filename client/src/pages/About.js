      ...
      <Container>
        ...
        <section className="text col-md-8" >
          ...
          <Row>
            ...
            <p className="text-wrap col-md-6">Leandro Parrado is the coder/artist who created all of the illustrations seen in the game and also co-wrote the story. </p>
          </Row>
          ...
          <Row>
            <img src="images/IMG_3610.jpeg" alt="Placeholder" className="profile col-md-4"></img>
